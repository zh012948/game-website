<?php
    /*
    Plugin Name: CTL Arcade - Wheel of Fortune
    Plugin URI: http://www.codethislab.com/
    Description: Wheel of Fortune for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeWheelFortune {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-wheel-fortune";
        private $_szPluginName              = "Wheel of Fortune";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "casino game, gambling game, html5 gambling, instant win, lottery, lucky, lucky game, poker, slot, sweepstakes";
    ...
    $g_oCTLArcadeWheelFortune =  new CTLArcadeWheelFortune();