<?php
    /*
    Plugin Name: CTL Arcade - Slot Space Adventure
    Plugin URI: http://www.codethislab.com/
    Description: Slot Space Adventure for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSlotSpaceAdventure {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-slot-space-adventure";
        private $_szPluginName              = "Slot Space Adventure";
        private $_szAspectRatio             = "7:3";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "bonus, bonus game, casino, gambling, html5, instant win, mobile, money, poker, slot, slot machine, space, videopoker, win";
    ...
    $g_oCTLArcadeSlotSpaceAdventure =  new CTLArcadeSlotSpaceAdventure();
